...
public class Caixa extends javax.swing.JFrame {
    ...
    private void btmEnvActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btmEnvActionPerformed
        ...
        boolean status;
        int resposta;
        ped.setDescricao(txtDesc.getText());
        ped.setFuncao(cmbFunc.getSelectedItem().toString());
        ped.setData(fmtData.getText());
        ped.setValor(fmtSald.getText());
        ...
        if (status == false) {
            ...
            resposta = DAO.cadastrarCaixa(ped);
            if (resposta == 1) {
